...
class JcomponentCreator {
    ...
    function generateControllerPhp() {
        ...
        $php_content [] = '}';
        $php_content [] = 'function display($cachable = false)';
        $php_content [] = '{';
        $php_content [] = '  parent::display($cachable);';
        $php_content [] = '}';
        $php_content [] = '}';
        $php_str = implode("\r\n", $php_content);
        return $php_str;
...
if (isset($_POST['sname'])) {
    ...
    $new_component->generateSiteFolders();
    $new_component->generateAdminFolders();
    $new_component->addToZip($new_component->createFile('admin/'.$new_component->compname . '.php', $new_component->generateAdminMainPhp()));
    $new_component->addToZip($new_component->createFile('admin/controller.php', $new_component->generateControllerPhp()));

    $new_component->createAndSaveZip();
    $new_component->deleteTmpFolders();
}
?>
<html>
    <head>
    ...
    <body>
        ...
        <div class="jumbotron"> 
            ...
            <table width="50%" class="table table-striped table-hover">
                ...
                <tr>
                    <td>CreationDate:</td>
                    <td><input class="form-control" type="text" value="<?php echo date('F Y'); ?>" name="creationdate"
                               size="45" /></td>
                </tr>
                <tr>
                    <td>Version:</td>
                ...
                <tr>
                    <td>Copyright:</td>
                    <td><input class="form-control" type="text" value="Copyright 2010 - 2014. All rights reserved" name="copyright"
                               size="45" /></td>
                </tr>
                <tr>
                    <td>License:</td>
